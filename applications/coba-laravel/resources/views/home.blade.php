...
<html lang="en">
  <head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="/assets/img/icon-wr.png" />
    <!-- Font Awesome-->
    <link
      rel="stylesheet"
  ...
  <body id="page-top">
    ...
    <header class="masthead d-flex align-items-center">
      <div class="container px-4 px-lg-5 text-center">
        <h1 class="mb-1">Welcome To Our Pages</h1>
        <h3 class="mb-5"><em>Wiraradja</em></h3>
  ...
  <div class="container px-4 px-lg-5 text-center">
    ...
    <section class="content-section" id="portfolio">
      <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-0">
          <div class="col-lg-6">
            <a class="portfolio-item" href="detaillbh">
              <div class="caption">
                <div class="caption-content">
                  <div class="h2">Lembaga Bantuan Hukum</div>
                  <p class="mb-0">
                    Lembaga bantuan hukum merupakan pilar penting dalam
                    memberikan perlindungan dan keadilan bagi warga kecil,
                    memastikan bahwa hak-hak mereka dihormati dan mendorong
              ...
              <img
                class="img-fluid"
                src="assets/img/services-01.png"
                alt="..."
              />
            </a>
          </div>
            ...
            <a class="portfolio-item" href="page-events.php">
              <div class="caption">
                <div class="caption-content">
                  ...
                  <p class="mb-0">
                    Hadirilah pagelaran events yang menggugah semangat
                    perlawanan dan kebebasan independen, di mana para seniman
                    hebat berani mengekspresikan kreativitas mereka secara
                    autentik dan melawan batasan-batasan konvensional.
                  </p>
                </div>
              </div>
              <img
                class="img-fluid"
                src="assets/img/services-03.png"
                alt="..."
              />
            </a>
          </div>
            ...
            <a class="portfolio-item" href="page-events.php">
              <div class="caption">
                <div class="caption-content">
                  ...
                  <p class="mb-0">
                    UMKM di Kampung Wiraradja merupakan pendorong utama
                    pertumbuhan ekonomi lokal, menciptakan peluang kerja, dan
              ...
              <img
                class="img-fluid"
                src="assets/img/services-02.png"
                alt="..."
              />
            </a>
          </div>
            ...
            <a class="portfolio-item" href="page-events.php">
              <div class="caption">
                <div class="caption-content">
                  ...
                  <p class="mb-0">
                    Lihat lebih banyak lagi kinerja kami dalam membuat dampak
                    perubahan sosial yang nyata walau dalam skena kecil!
                  </p>
                </div>
              </div>
              <img
                class="img-fluid"
                src="assets/img/services-04.png"
                alt="..."
              />
            </a>
          </div>
